                    ...
                    <Row center="xs">
                        <Form className="small-form-style">
                            ...
                            <FormIconField width="one-half" iconPosition="left" iconColor="default" iconKey="question">
                                <FormInput placeholder="Reminder" name="icon-alignment-left" ref={node => {
                                    reminderInput = node
                                }}/>
                            </FormIconField>
                            ...
                            <FormField>
                                <Button block size="sm" type="success" onClick={() => this.register()}>Register</Button>
                            </FormField>

                            <FormField>
                                <Button block size="sm" type="default" onClick={() => this.props.cancel()}>Cancel</Button>
                            </FormField>
                        </Form>
                    </Row>
                </Col>
